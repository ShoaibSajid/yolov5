...
python train.py \
--batch-size 64 \
--data /home/shoaib/codes/Yolov5_DeepSORT_PseudoLabels/yolov5/data_HCK/HCK_filter_recover_yolov5s_v3/HACKTHON_full_org-good_pred-failed.yaml \
--cfg models/yolov5s.yaml \
--device 1 \
--name Shoaib/HCK/HCK_Exp5_Yolov5S/Yolov5s_Retrain_using_passedGT_failedPD_v3 \
--weights runs/train/Shoaib/HCK/HCK_Exp5_Yolov5S/Yolov5s_Train_from_scratch_using_full_GT/weights/best.pt \
--epochs 500 \
--exist-ok --cache
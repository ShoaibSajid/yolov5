...
torchrun --nproc_per_node=2  --master_port=23 train.py \
--batch-size 64 \
--data /home/shoaib/codes/Yolov5_DeepSORT_PseudoLabels/yolov5/data_HCK/HCK_filter_yolov5s/HACKTHON_full_org-good_pred-failed.yaml \
--cfg models/yolov5s.yaml \
--device 2,3 \
--name Shoaib/HCK/HCK_Exp5_Yolov5S/Yolov5s_Retrain_using_passedGT_failedPD_v1 \

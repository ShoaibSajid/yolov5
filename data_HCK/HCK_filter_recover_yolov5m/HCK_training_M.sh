...
torchrun --nproc_per_node=4  --master_port=4567 train.py \
--batch-size 64 \
--data /home/shoaib/codes/Yolov5_DeepSORT_PseudoLabels/yolov5/data_HCK/HCK_filter_recover_yolov5m/HACKTHON_full_org-good_pred-failed.yaml \
--cfg models/yolov5m.yaml \
--device 4,5,6,7 \
--name Shoaib/HCK/HCK_Exp4_Yolov5M/Yolov5m_Retrain_using_HCK_passedGT_failedPD_v3 \
--weights runs/train/Shoaib/HCK/HCK_Exp4_Yolov5M/Yolov5m_Train_from_scratch_using_full_GT/weights/best.pt  \
--epochs 500 \

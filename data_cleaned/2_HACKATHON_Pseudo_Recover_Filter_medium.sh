...
NAME="Yolov5m_HCK_TrainingData_CleanedWeights_Recover_Filter_Clean"
Yolo_weights=$YOLO/runs/train/Shoaib/HCK/HCK_Exp6_Cleaned/yolov5m/Train_with_cleaned_GT/weights/best.pt
DATASET="HCK"
EXP="Exp6_Yolov5m"
...
recover_labels_forward_pass=false
recover_labels_backward_pass=false
merge_forward_backward=false
filter_images=true

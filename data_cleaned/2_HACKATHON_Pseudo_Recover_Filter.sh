...
NAME="Yolov5s_HCK_TrainingData_CleanedWeights_Recover_Filter_Clean"
Yolo_weights=$YOLO/runs/train/Shoaib/HCK/HCK_Exp6_Cleaned/yolov5s/Train_with_cleaned_GT/weights/best.pt
DATASET="HCK"
EXP="Exp6_Yolov5s"
...
Batch="64"
Device="6"
DATA=$YOLO/data_cleaned/2_HACKTHON_cleaned_GT_valistrain.yaml
DATA_GT="/home/shoaib/datasets/HCK/HACKATHON_Cleaned_g20_ar3/train"
DATA_list="/home/shoaib/datasets/HCK/HACKATHON_Cleaned_g20_ar3/train_labels_list.txt"
...
# Configurations
print_info=true
generate_pseudos_low=true
generate_pseudos_high=true
move_low_confidence_to_pseudos=true
move_high_confidence_to_pseudos=true
copy_images_to_LC_for_deepSORT=true

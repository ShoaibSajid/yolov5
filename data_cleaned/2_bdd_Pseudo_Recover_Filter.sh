...
NAME="Yolov5s_BDD_TrainingData_CleanedWeights_Recover_Filter_Clean"
Yolo_weights=$YOLO/runs/train/Shoaib/BDD/BDD_Exp9_Cleaned/yolov5s/Train_with_cleaned_GT/weights/best.pt
DATASET="BDD"
EXP="Exp9_Yolov5s"
